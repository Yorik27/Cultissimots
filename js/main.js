...
let trackList = [
  {
    ...
    path: "sources/sons/C'est pas moi c'est les autres.mp3"
  ...
  },
  {
    ...
    path: "sources/sons/Les cons ça ose tout.mp3"
  ...
  },
  {
    ...
    path: "sources/sons/Nos jours heureux.mp3"
  },
  {
    ...
    path: "sources/sons/Comment vous allez l'appeler ce petit canard.mp3"
  },
  {
    acteur: "Jean Carmet",
    personnage: "Le Bombé",
    ...
    path: "sources/sons/C'est quand même ben foutu les étoiles.mp3"
  },
  {
    ...
    path: "sources/sons/Ca va être tout noir!.mp3"
  },
  {
    acteur: "Franck Pitiot",
    personnage: "Perceval",
    ...
    path: "sources/sons/C'est pas faux.mp3"
  },
  {
    ...
    path: "sources/sons/Y a pas mort d'homme.mp3"
  },
  {
    ...
    path: "sources/sons/Je suis une aventure.mp3"
  },
  {
    ...
    path: "sources/sons/Le plaisir d'un vrai vendeur.mp3"
  },
  {
    ...
    path: "sources/sons/Vous voulez un whisky.mp3"
  },
  {
    ...
    path: "sources/sons/La Finlandaise.mp3"
  },
  {
    acteur: "Jean Gabin",
    personnage: "Grandgil",
    ...
    path: "sources/sons/La traversée de Paris.mp3"
  },
  {
    acteur: "Michel Blanc",
    ...
    path: "sources/sons/Sur un malentendu.mp3"
  },
  {
    ...
    path: "sources/sons/C'est systématiquement débile.mp3"
  },
  {
    acteur: "Jean-Pierre Marielle",
    ...
    path: "sources/sons/L'admirable cholestérol.mp3"
  },
  {
    ...
    path: "sources/sons/Un gros kiki.mp3"
  },
  {
    acteur: "Kad Merad",
    ...
    path: "sources/sons/Bienvenue Chez Les Chtis.mp3"
  },
  {
    ...
    path: "sources/sons/Saisons Du Plaisir.mp3"
  },
  {
    ...
    path: "sources/sons/Albert est mechant.mp3"
  },
  {
    ...
    path: "sources/sons/Je suis ministre, je ne sais rien faire.mp3"
  },
  {
    ...
    path: "sources/sons/Clarté dans la confusion.mp3"
  },
];
