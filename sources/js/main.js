...
let trackList = [
  {
    ...
    path: "sources/Fichiers sons/C'est pas moi c'est les autres.mp3"
  ...
  },
  {
    ...
    path: "sources/Fichiers sons/Les cons ça ose tout.mp3"
  ...
  },
  {
    ...
    path: "sources/Fichiers sons/Nos jours heureux.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Comment vous allez l'appeler ce petit canard.mp3"
  },
  {
    acteur: "Jean Carmet",
    personnage: "Le Bombé",
    ...
    path: "sources/Fichiers sons/C'est quand même ben foutu les étoiles.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Ca va être tout noir!.mp3"
  },
  {
    acteur: "Franck Pitiot",
    personnage: "Perceval",
    ...
    path: "sources/Fichiers sons/C'est pas faux.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Y a pas mort d'homme.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Je suis une aventure.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Le plaisir d'un vrai vendeur.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Vous voulez un whisky.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/La Finlandaise.mp3"
  },
  {
    acteur: "Jean Gabin",
    personnage: "Grandgil",
    ...
    path: "sources/Fichiers sons/La traversée de Paris.mp3"
  },
  {
    acteur: "Michel Blanc",
    ...
    path: "sources/Fichiers sons/Sur un malentendu.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/C'est systématiquement débile.mp3"
  },
  {
    acteur: "Jean-Pierre Marielle",
    ...
    path: "sources/Fichiers sons/L'admirable cholestérol.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Un gros kiki.mp3"
  },
  {
    acteur: "Kad Merad",
    ...
    path: "sources/Fichiers sons/Bienvenue Chez Les Chtis.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Saisons Du Plaisir.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Albert est mechant.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Je suis ministre, je ne sais rien faire.mp3"
  },
  {
    ...
    path: "sources/Fichiers sons/Clarté dans la confusion.mp3"
  },
];
